...
class ENetPeer
{
    ...
    public List<ENetInCmd> dispatchedCmds = new();
    ...
    public void DispatchInReliableCmds(ENetChannel channel, ENetInCmd? queuedCmd)
    {
        ...
        ENetInCmd currentCmd = channel.inReliableCmds[0];
        ENetInCmd startCmd = currentCmd;
